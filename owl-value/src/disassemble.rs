...
impl Chunk {
    ...
    fn disassemble_instr(
        ...
        match OpCode::from_u8(instr) {
            ...
            Some(OpCode::AddF64) => self.simple_instr(f, "add.f64", offset, msg),
            Some(OpCode::SubF64) => self.simple_instr(f, "sub.f64", offset, msg),
            Some(OpCode::MulF64) => self.simple_instr(f, "mul.f64", offset, msg),
            Some(OpCode::DivF64) => self.simple_instr(f, "div.f64", offset, msg),
